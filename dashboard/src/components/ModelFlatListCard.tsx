        ...
        >
            ...
            <Modal isOpen={isCreateModelOpen} onClose={() => setIsCreateModelOpen(false)} closeable animate autoFocus>
                ...
                <ModalBody>
                    <div>
                        <p>
                            1. {t('Follow to [mlML quickstart guide] to create your first Model. prefix')}
                            <Link href='https://docs.mlml.org/en/latest/tutorial.html' target='_blank'>
                                {t('mlML quickstart guide')}
                            </Link>
                            {t('Follow to [mlML quickstart guide] to create your first Model. suffix')}
                        </p>
                        <p>
                        ...
                        <p>
                            3. {t('Push new Model to yeti with the `mlml models push` CLI command. prefix')}
                            <SyntaxHighlighter
                                language='bash'
                            ...
                            {t('Push new Model to yeti with the `mlml models push` CLI command. suffix')}
                        </p>
                    </div>
                </ModalBody>
            </Modal>
